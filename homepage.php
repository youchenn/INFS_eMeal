...
<!--        <link rel="stylesheet" href="css/mobile.css">-->
        ...
        <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5ab88174f9a49214"></script>
    ...
    <body>
        <div id="navigation">
            ...
            <div class="dropdown"><p>MENU</p>
                <div class="dropdown-content">
                    ...
                    <a href="magazines.html">STYLE</a>
                    <a href="stories.html">PURPOSE</a>
                    <a href="contactus.html">BOX SIZE</a>
        ...
        <div class="white">
            <p class="subtitle">FIND THE LATEST IDEA</p>
            <p class="title"><span>LATEST</span> MENU</p>
            <div class="box-general">
            <p class="categorybox">Author</p>
            <img class="lunchbox-img2" src="img/susanna.jpg" alt="">
            <p class="box-brief"></p>
            <a class="viewbox" href="story_susanna.html">View More</a>
        </div>
        </div>
        <div class="gray">
