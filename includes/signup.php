			...
			if (!preg_match("/^[a-zA-Z]*$/", $nickname)) {
				...
				if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
					...
					if ($resultCheck > 0) {
						...
						$sql = "INSERT INTO `user` (`userId`, `userEmail`, `userPassword`, `userAddress`, `userPostalcode`, `userState`, `userContact`, `userNickname`, `userProfilepic`, `userBio`, `userGender`, `userDob`, `userOccupation`, `userRecipecount`, `userWebsite`, `userActivationCode`, `userEmailStatus`) VALUES (NULL, '$email', '$hashedPwd', NULL, NULL, NULL, NULL, '$nickname', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '$hash', 'not verified');";
						...
						$mail->Body = '
							...
							http://localhost/INFS_eMeal/includes/verify.php?email='.$email.'&hash='.$hash;
						...
						header("Location: ../homepage.html?signup=emailfail");}
